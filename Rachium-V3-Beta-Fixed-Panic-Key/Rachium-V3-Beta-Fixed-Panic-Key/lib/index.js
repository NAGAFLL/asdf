...
module.exports = class {
    ...
    http(req, res, next = () => res.end('')) {
        ...
        delete proxyOptions.headers['host'];
            ...
            // Add specific headers for now.gg
            if (proxyURL.hostname.includes('now.gg')) {
                proxyOptions.headers['sec-fetch-site'] = 'same-origin';
                proxyOptions.headers['sec-fetch-mode'] = 'navigate';
                proxyOptions.headers['sec-fetch-dest'] = 'document';
                proxyOptions.headers['sec-ch-ua-platform'] = '"Windows"';
                proxyOptions.headers['sec-ch-ua-mobile'] = '?0';
                proxyOptions.headers['upgrade-insecure-requests'] = '1';
            }
        ...
        if (this.config.headers) {
            proxyOptions.headers = {...proxyOptions.headers, ...this.config.headers};
        }
